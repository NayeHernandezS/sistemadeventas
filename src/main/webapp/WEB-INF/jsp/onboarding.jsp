                ...
                <div class="card-body p-4 p-md-5">
                    ...
                    <c:if test="${paso == 1}">
                        ...
                        <p class="small text-muted mb-0">
                            Manual para el dia a dia: archivo
                            <code>docs/GUIA_OPERATIVA_NEGOCIO.md</code> en el proyecto (entregable en PDF al dar de alta).
                    ...
                    <c:if test="${paso == 2}">
                        <h1 class="h3 mb-3"><i class="bi bi-box-seam"></i> Tu primer producto</h1>
                        <p class="text-muted">Registra al menos un articulo para probar ventas en mostrador.</p>

                        <c:if test="${not empty errores.general}">
                            <div class="alert alert-danger">${errores.general}</div>
                        </c:if>

                        <form method="post" action="${pageContext.request.contextPath}/onboarding/producto" class="row g-3">
                            <%@ include file="csrf.jspf" %>
                            <div class="col-md-8">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="sku" name="sku" maxlength="10"
                                       value="${sku}" required placeholder="SKU001">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="existencias" name="existencias" min="0"
                                       value="${empty existencias ? 10 : existencias}" required>
                    ...
                    <c:if test="${paso == 3}">
                        ...
                        <p class="text-muted">
                            Ya tienes categorias y al menos un producto. El siguiente paso es registrar tu primera venta.
                        </p>
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <a href="${pageContext.request.contextPath}/crudprod" class="btn btn-outline-primary">
                                Ver inventario
                            </a>
                        </div>
                    </c:if>
